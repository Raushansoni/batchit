...
fun ProfileSetupScreen(
  ...
  Column(
    ...
    Text(
      text = stringResource(id = R.string.auth_profile_title),
      style = MaterialTheme.typography.headlineSmall,
      color = getTitleColor()
    )
    Spacer(modifier = Modifier.height(8.dp))
    Text(
      text = stringResource(id = R.string.auth_profile_subtitle),
    ...
    OutlinedTextField(
      ...
      label = { Text(text = stringResource(id = R.string.auth_name_hint)) },
      singleLine = true,
